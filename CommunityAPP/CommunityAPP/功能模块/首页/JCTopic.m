...
-(void)upDate{
    ...
    for (id obj in self.pics) {
        ...
        if ([[obj objectForKey:@"isLoc"]boolValue]) {
            ...
            [tempImage setImageWithURL:[NSURL URLWithString:[obj objectForKey:@"pic"]] placeholderImage:[UIImage imageNamed:@"bg_sample_2.png"]  usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
            /*
