...
@interface MWPhotoBrowser () {
    ...
    *_navigationBarBackgroundImageLandscapePhone;
    UIColor *_previousNavBartextColor;
...
// Private Properties
@property (nonatomic, retain) UIColor *previousNavBartextColor;
...
// Properties
@synthesize previousNavBartextColor = _previousNavBartextColor;
...
- (void)dealloc {
    ...
    [_previousNavBartextColor release];
...
- (void)storePreviousNavBarAppearance {
    ...
    self.previousNavBartextColor = self.navigationController.navigationBar.tintColor;
...
- (void)restorePreviousNavBarAppearance:(BOOL)animated {
    if (_didSavePreviousStateOfNavBar) {
        self.navigationController.navigationBar.tintColor = _previousNavBartextColor;
