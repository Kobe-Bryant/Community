...
const CGFloat MJRefreshViewHeight = 40.0;
const CGFloat MJRefreshAnimationDuration = 0.25;

NSString *const MJRefreshBundleName = @"MJRefresh.bundle";

NSString *const MJRefreshFooterPullToRefresh = @"下拉可以刷新";//@"上拉可以加载更多数据";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开立即刷新";//@"松开立即加载更多数据";
NSString *const MJRefreshFooterRefreshing = @"正在刷新";//@"MJ哥正在帮你加载数据...";
