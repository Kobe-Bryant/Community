...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 3.状态标签
        [self addSubview:_statusLabel = [self labelWithFontSize:16]];
        ...
        CircleView *circleView = [[CircleView alloc] initWithFrame:CGRectMake(100, 8, 28, 28)];
...
- (void)setFrame:(CGRect)frame
{
    ...
    [super setFrame:frame];
     ...
     _statusLabel.frame = CGRectMake(105, 8, 150, 30);
    /*
