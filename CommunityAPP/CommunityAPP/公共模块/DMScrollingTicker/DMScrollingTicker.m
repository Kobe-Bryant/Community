...
#define kLPScrollingTickerHSpace                20.0f
...
#define kLPScrollingTickerLabelItem_Title_Font          [UIFont systemFontOfSize:14.0f]
...
- (id) initWithTitle:(NSString *) title description:(NSString *) description {
    ...
    if (self) {
        ...
        titleLabel.textColor = [UIColor colorWithRed:66.0/255 green:66.0f/255 blue:66.0f/255 alpha:1.0];
        ...
        descriptionLabel.textColor = [UIColor colorWithRed:66.0/255 green:66.0f/255 blue:66.0f/255 alpha:1.0];
