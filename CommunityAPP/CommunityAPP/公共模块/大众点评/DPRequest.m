...
+ (NSString *)serializeURL:(NSString *)baseURL params:(NSDictionary *)params
{
	...
	NSMutableString *signString = [NSMutableString stringWithString:[[AppDelegate instance] dpapiAppKey]];
	NSMutableString *paramsString = [NSMutableString stringWithFormat:@"appkey=%@", [[AppDelegate instance] dpapiAppKey]];
	...
	[signString appendString:[[AppDelegate instance] dpapiAppSecret]];
